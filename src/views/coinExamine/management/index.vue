  ...
  >
    ...
    >
      ...
      <template #action="{ record }">
        <TableAction
          :dropDownActions="funcKeyArray.includes('toExamine') ? [
            {
              label: '审核通过',
              popConfirm: {
                title: '是否审核通过？',
...
export default defineComponent({
  name: 'AccountModal',
  components: { PageWrapper, BasicForm, BasicTable, TableAction, Dropdown, [Select.name]: Select, ASelectOption: Select.Option },
