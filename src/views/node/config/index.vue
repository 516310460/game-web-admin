...
import { GetCountryConfPageApi, DeleteCountryConfApi } from '/@/api/Manager/SysCountryConf';
  ...
  setup() {
    ...
    async function getSelectRowList() {
      ...
      if(rows.length){
        ...
        await DeleteCountryConfApi({ids: rowArray.join()});
        reload();
      }
    }
    ...
    async function handleDelete(record: Recordable) {
      ...
      await DeleteCountryConfApi({ids: record.id});
      reload();
    }
