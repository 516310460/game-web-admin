...
import {
  GetOtcCoinListConfPageApi,
  DeleteOtcCoinListConfApi,
} from '/@/api/Manager/OtcCoinListConf';
  ...
  setup() {
    ...
    async function getSelectRowList() {
      ...
      if (rows.length) {
        ...
        await DeleteOtcCoinListConfApi({ ids: rowArray.join() });
        reload();
      }
    }
    ...
    async function handleDelete(record: Recordable) {
      ...
      await DeleteOtcCoinListConfApi({ ids: record.id });
      reload();
    }
